      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-2xl">
          ...
          delay: 0.4
            ...
            {benefits.map((benefit, index) => <li key={index} className="flex items-center gap-3 bg-background/10 backdrop-blur-sm border border-primary/30 rounded-full px-5 py-2.5 w-full max-w-2xl">
