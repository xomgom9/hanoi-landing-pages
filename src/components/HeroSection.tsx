...
const benefits = [
  "Sáng – Sang trọng, nâng tầm không gian nhà phố & biệt thự.",
  "Thạch anh giúp ổn định năng lượng, lan tỏa vượng khí cho trục cầu thang.",
  "Chống thấm ố – Bền đẹp vượt thời gian.",
];
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-2xl">
          ...
          >
            <a
              href="#contact"
              className="btn-gold rounded-full flex items-center justify-center gap-2 group"
            >
            ...
            <a
              href="#mau-da"
              className="btn-outline-gold rounded-full text-center"
            >
